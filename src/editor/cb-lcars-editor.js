...
export class CBLCARSCardEditor extends EditorForm {
    ...
    async setConfig(config) {
        ...
        try {
            ...
            this._mergeUserStyles = formDefinitions[this._cardType].css.mergeUserStyles !== undefined && formDefinitions[this._cardType].css.mergeUserStyles !== null ? formDefinitions[this._cardType].css.mergeUserStyles : true;
