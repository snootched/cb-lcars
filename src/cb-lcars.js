    ...
    */
    ...
    _updateCardSize() {
        ...
        if(this.parentElement){
            ...
            console.log('Parent element not found in _updateCardSize');
        }
    }
    ...
    render() {
        ...
        return html`
            <cblcars-button-card
                ...
                style="display: block; --button-card-width: ${this._lastWidth}px; --button-card-height: ${this._lastHeight}px; min-height: 50px;"
            ></cblcars-button-card>
        `;
